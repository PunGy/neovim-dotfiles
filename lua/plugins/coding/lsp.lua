...
local diagnostics_ui = {severity_sort = true, signs = {text = {" ", " ", " ", " "}}, underline = true, virtual_lines = {current_line = false}, virtual_text = {prefix = "\226\151\143", source = "if_many", spacing = 4}, float = {border = "rounded", source = "if_many"}, update_in_insert = false}
